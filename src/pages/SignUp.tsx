  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.session) {
        ...
        toast({ title: "Account created", description: "Signed up and signed in" });
        navigate("/home");
        return;
      }
      ...
      toast({ title: "Check your email", description: "Confirm your account via the email sent to you." });
      navigate("/");
    } catch (err: any) {
    ...
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="w-full max-w-md mx-auto p-6">
        <div className="bg-transparent border border-white/20 rounded-2xl p-8 shadow-md animate-in slide-in-from-right-8 backdrop-blur-md">
          ...
          <p className="text-sm text-muted-foreground mb-6">Create your account and start receiving recommendations</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/" className="text-sm text-primary underline">Already have an account?</Link>
            </div>
